...
const HomeHero = () => {
  return (
    <section className="bg-primary w-full relative pt-28 -mt-32 sm:-mt-28">
      <Container>
        <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between">
          <div className="max-w-lg 2xl:max-w-[812px] flex-shrink">
            <h1 className="text-secondary text-2xl font-light text-center sm:text-left mt-16 sm:mt-36">
              Tłumaczenia ustne <span className="hidden sm:inline">|</span>{" "}
            ...
            <div className="text-white mb-36 md:mb-64">
              <h3 className="text-2xl font-medium mt-11 mb-5 ml-5 sm:mt-24 z-10 text-center sm:text-left">
        ...
        <Link href="/uslugi" passHref>
          <Button
            size="big"
            className="absolute -bottom-14 left-1/2 tranform -translate-x-1/2 md:left-auto md:transform-none flex items-center z-10"
          >
